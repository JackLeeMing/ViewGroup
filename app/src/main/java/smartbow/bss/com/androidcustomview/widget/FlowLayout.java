    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       ...
       int height = getPaddingTop() + getPaddingBottom();
        ...
        for(int i = 0; i < childCount; i++) {
            ...
            int childHeightSize = sizeHeight-heightUsed;
            ...
            if(lineWidth + childWidth > sizeWidth-widthUsed) {//很长 换行

                width = Math.max(width, lineWidth);//前一行的width 和当前行的width
